...
export const ui = {
  en: {
    meta: {
      ...
      pricingDescription:
        "Compare Synch plans and storage limits for end-to-end encrypted Obsidian vault sync.",
      blogTitle: "Blog - Synch",
      blogDescription:
        "Articles about end-to-end encrypted Obsidian sync, privacy, and Synch development.",
      ...
      billingSuccessDescription:
        "Confirming your Synch subscription and applying it to your account.",
    ...
    home: {
      ...
      installIntro: "Install Synch directly from Obsidian's Community plugins browser.",
      installSteps: [
        ["Open Obsidian Settings and go to", "Community plugins", "."],
        ["Turn off Restricted mode and select", "Browse", "."],
        ["Search for", "Synch by hjinco", " and select it."],
        ["Select", "Install", "."],
    ...
    billingSettings: {
      ...
      subheading:
        "View your current plan and open the billing portal to change or cancel your subscription.",
      ...
      activeMessage:
        "Your subscription is active. Open the billing portal to change your plan, cancel, or update payment details.",
      cancelingMessage:
  ...
  ko: {
    meta: {
      ...
      pricingDescription:
        "종단 간 암호화 Obsidian vault 동기화를 위한 Synch 요금제와 저장 용량을 비교하세요.",
      blogTitle: "블로그 - Synch",
      blogDescription:
        "종단 간 암호화 Obsidian 동기화, 개인정보 보호, Synch 개발에 관한 글을 읽어보세요.",
    ...
    home: {
      ...
      installTitle: "설치 방법",
      installIntro: "Obsidian의 Community plugins 브라우저에서 Synch를 바로 설치할 수 있습니다.",
      installSteps: [
        ["Obsidian 설정을 열고", "Community plugins", "로 이동합니다."],
        ["제한 모드를 끄고", "Browse", "를 선택합니다."],
        ["", "Synch by hjinco", "를 검색해 선택합니다."],
        ["", "Install", "을 선택합니다."],
        ["설치가 끝나면", "Enable", "을 선택합니다."],
      ],
      selfHosting: {
    ...
    billingSettings: {
      ...
      activeMessage:
        "구독이 활성화되어 있습니다. 결제 포털에서 요금제 변경, 구독 취소, 결제수단 변경을 할 수 있습니다.",
      cancelingMessage: "현재 결제 기간이 끝나면 구독이 취소될 예정입니다.",
      canceledMessage: "구독이 취소되었습니다. 현재 요금제는 무료입니다.",
      freeMessage:
        "현재 무료 요금제를 사용 중입니다. 더 많은 저장 공간이 필요하면 업그레이드하세요.",
      manage: "구독 관리",
      upgrade: "요금제 보기",
  ...
  ja: {
    meta: {
      ...
      pricingDescription:
        "エンドツーエンド暗号化されたObsidian vault同期向けのSynchプランと容量を比較できます。",
      blogTitle: "ブログ - Synch",
      blogDescription:
        "エンドツーエンド暗号化されたObsidian同期、プライバシー、Synch開発に関する記事です。",
    ...
    home: {
      ...
      installIntro: "ObsidianのCommunity pluginsブラウザからSynchを直接インストールできます。",
      installSteps: [
        ["Obsidian設定を開き", "Community plugins", "へ移動します。"],
        ["制限モードをオフにして", "Browse", "を選択します。"],
        ["", "Synch by hjinco", "を検索して選択します。"],
        ["", "Install", "を選択します。"],
        ["インストール完了後、", "Enable", "を選択します。"],
      ],
      selfHosting: {
    ...
    billingSettings: {
      ...
      activeMessage:
        "サブスクリプションは有効です。請求ポータルでプラン変更、解約、支払い方法の更新ができます。",
  ...
  "zh-cn": {
    ...
    home: {
      ...
      installTitle: "如何安装",
      installIntro: "可以直接从 Obsidian 的 Community plugins 浏览器安装 Synch。",
      installSteps: [
        ["打开 Obsidian 设置并进入", "Community plugins", "。"],
        ["关闭受限模式，然后选择", "Browse", "。"],
        ["搜索并选择", "Synch by hjinco", "。"],
        ["选择", "Install", "。"],
        ["安装完成后选择", "Enable", "。"],
      ],
      selfHosting: {
    ...
    blog: {
      ...
      ctaBody: "免费开始使用端到端加密同步；如果需要更多存储和更长版本历史，也可以比较方案。",
      ctaPrimary: "开始使用",
      ctaSecondary: "查看价格",
    },
    billing: {
  ...
  "zh-tw": {
    ...
    home: {
      ...
      installTitle: "如何安裝",
      installIntro: "可以直接從 Obsidian 的 Community plugins 瀏覽器安裝 Synch。",
      installSteps: [
        ["開啟 Obsidian 設定並前往", "Community plugins", "。"],
        ["關閉受限模式，然後選擇", "Browse", "。"],
        ["搜尋並選擇", "Synch by hjinco", "。"],
        ["選擇", "Install", "。"],
        ["安裝完成後選擇", "Enable", "。"],
      ],
      selfHosting: {
    ...
    blog: {
      ...
      ctaBody: "免費開始使用端對端加密同步；如果需要更多儲存空間和更長版本記錄，也可以比較方案。",
      ctaPrimary: "開始使用",
      ctaSecondary: "查看價格",
    },
    billing: {
