...
describe("plugin version routes", () => {
  it("returns ok for a supported Obsidian plugin version", async () => {
    ...
    const response = await app.request("/v1/obsidian-plugin/version-check?version=0.0.9");
  ...
  it("returns update_required for an unsupported Obsidian plugin version", async () => {
    ...
    const response = await app.request("/v1/obsidian-plugin/version-check?version=0.0.7");
  ...
  it("rejects malformed versions", async () => {
    ...
    const response = await app.request("/v1/obsidian-plugin/version-check?version=0.0.8-beta.1");
