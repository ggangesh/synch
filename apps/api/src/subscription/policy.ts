...
export type SubscriptionProductIdsByPlanId = Partial<
  Record<PaidSubscriptionPlanId, Partial<Record<SubscriptionBillingInterval, string>>>
>;
...
export function getSubscriptionPlanPolicy(planId: SubscriptionPlanId): SubscriptionPlanPolicy {
