...
import { formatClientControlMessageError, parseClientControlMessage } from "../protocol";
...
describe("sync protocol schema", () => {
  ...
  it("rejects a blank entry id", () => {
    ...
    expect(formatClientControlMessageError(parsed.error)).toContain("mutations.0.entryId");
  });
