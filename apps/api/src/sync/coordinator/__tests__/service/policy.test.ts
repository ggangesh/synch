...
import { formatHistoryRetention, getSubscriptionPlanPolicy } from "../../../../subscription/policy";
...
describe("coordinator subscription policy", () => {
  it("uses the free plan one-day version history policy", () => {
    ...
    expect(formatHistoryRetention(policy.limits.versionHistoryRetentionDays)).toBe(
