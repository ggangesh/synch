import { requireSyncToken, type SyncTokenClaims, signSyncToken } from "./token";

export class SyncTokenService {
  constructor(private readonly secret: string) {}

  async requireSyncToken(request: Request, expectedVaultId?: string): Promise<SyncTokenClaims> {
